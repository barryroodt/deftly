...
**MANDATORY — load `references/tech-stacks.md`** for the marker-file
→ stack → allow-rules table. Walk each cloned repo, record matched
stacks, and present the list to the user for confirmation before
passing to adapters in Step 2.5.
